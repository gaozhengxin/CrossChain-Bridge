...
func (b *Bridge) BuildSpendFromBip32Tx(from, to, inputCode string, extra *tokens.FilExtraArgs) (rawTx interface{}, err error) {
...
func (b *Bridge) BuildAggregateTransaction(args *tokens.BuildTxArgs) (rawTx interface{}, err error) {
	if args == nil || args.Extra == nil || args.Extra.FilExtra == nil {
